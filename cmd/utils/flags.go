...
import (
	...
	"github.com/kek-chain/go-kekchain/consensus/clique"
	...
	ethcatalyst "github.com/kek-chain/go-kekchain/eth/catalyst"
	...
	"github.com/kek-chain/go-kekchain/graphql"
	...
	lescatalyst "github.com/kek-chain/go-kekchain/les/catalyst"
	"github.com/kek-chain/go-kekchain/log"
	"github.com/kek-chain/go-kekchain/metrics"
	"github.com/kek-chain/go-kekchain/metrics/exp"
	"github.com/kek-chain/go-kekchain/metrics/influxdb"
...
var (
	...
	KekTestFlag = cli.BoolFlag{
		Name:  "kektest",
		Usage: "KekTest network: pre-configured proof-of-authority test network",
	}
...
func setDataDir(ctx *cli.Context, cfg *node.Config) {
	...
	case ctx.GlobalBool(KekTestFlag.Name) && cfg.DataDir == node.DefaultDataDir():
...
func SetEthConfig(ctx *cli.Context, stack *node.Node, cfg *ethconfig.Config) {
	...
	CheckExclusive(ctx, MainnetFlag, DeveloperFlag, RopstenFlag, RinkebyFlag, GoerliFlag, KekTestFlag, SepoliaFlag)
