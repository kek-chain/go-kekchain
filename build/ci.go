...
import (
	...
	"github.com/CryptocurrencyDevelopers/go-ethereum/crypto/signify"
	"github.com/CryptocurrencyDevelopers/go-ethereum/internal/build"
...
func doAndroidArchive(cmdline []string) {
	...
	build.MustRun(gomobileTool("bind", "-ldflags", "-s -w", "--target", "android", "--javapkg", "org.ethereum", "-v", "github.com/CryptocurrencyDevelopers/go-ethereum/mobile"))
...
func doXCodeFramework(cmdline []string) {
	...
	bind := gomobileTool("bind", "-ldflags", "-s -w", "--target", "ios", "-v", "github.com/CryptocurrencyDevelopers/go-ethereum/mobile")
